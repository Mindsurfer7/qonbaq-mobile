...
import 'package:qonbaq/domain/usecases/update_business_partial.dart';
...
import 'package:qonbaq/domain/usecases/download_file.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final updateBusinessPartial = UpdateBusinessPartial(userRepository);
    ...
    final profileProvider = ProfileProvider(
      ...
      updateBusinessPartial: updateBusinessPartial,
    ...
    final downloadFile = DownloadFile(storageRepository);
    ...
    // Провайдер для заказов (воронка заказов)
    ...
    return MultiProvider(
      providers: [
        ...
        Provider<DownloadFile>(create: (_) => downloadFile),
